...
class XPU_Accelerator(Accelerator):
    ...
    # NOTICE align_bytes == 0
    # https://github.com/intel/intel-extension-for-deepspeed/blob/main/intel_extension_for_deepspeed/xpu_accelerator.py#L196
